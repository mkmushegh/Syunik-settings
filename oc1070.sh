...
nvidia-settings -a '[gpu:1]/GPUGraphicsClockOffset[3]=175'
...
nvidia-settings -a '[gpu:2]/GPUGraphicsClockOffset[3]=140' #OC edition clock offset is less than ordinary Gameing edition
...
nvidia-settings -a '[gpu:4]/GPUGraphicsClockOffset[3]=175'
...
nvidia-settings -a '[gpu:5]/GPUGraphicsClockOffset[3]=175'
